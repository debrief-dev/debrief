...
// letterKeys maps letter offset (A=0..Z=25) to macOS Carbon keycode.
// Carbon keycodes follow ANSI keyboard position and are NOT alphabetically sequential.
...
// digitKeys maps digit offset ('0'=0..'9'=9) to macOS Carbon keycode.
